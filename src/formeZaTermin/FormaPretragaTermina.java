...
import modeli.ModelTabeleTermin;

/**
 *
 * @author ivani
 */
public class FormaPretragaTermina extends javax.swing.JDialog {

    public FormaPretragaTermina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        ModelTabeleTermin model = new ModelTabeleTermin();
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((ModelTabeleTermin) tblTermini.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            Termin t = ((ModelTabeleTermin) tblTermini.getModel()).getSelectedTermin(row);
            new FormaDetaljiTermina(this, true, t).setVisible(true);
        }
    ...
    void refreshTable() {
        ModelTabeleTermin tm = (ModelTabeleTermin) tblTermini.getModel();
        tm.refreshTable();
    }
