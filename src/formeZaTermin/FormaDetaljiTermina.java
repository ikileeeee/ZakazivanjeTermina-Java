 ...
 * @author ivani
 */
public class FormaDetaljiTermina extends javax.swing.JDialog {

    private Termin t;
    private double ukupnaCena;

    public FormaDetaljiTermina(JDialog parent, boolean modal, Termin t) {
        super(parent, modal);
        initComponents();
        this.t = t;
        ...
        if (!t.getDatumVreme().after(new Date())) {
            ...
            lblObavestenje.setText("Proslo je vreme termina, ne mozete ga menjati!");
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtDatumVreme, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(348, 348, 348)
                .addComponent(lblObavestenje, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                KlijentKontroler.getInstance().deleteTermin(t);
                FormaPretragaTermina fp = (FormaPretragaTermina) getParent();
                fp.refreshTable();
                JOptionPane.showMessageDialog(this, "Uspesno obrisan termin.");
                this.dispose();
            } catch (Exception ex) {
                Logger.getLogger(FormaDetaljiTermina.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        ...
        try {
            ...
            t.setUkupnaCena(tm.vratiUkupnuCenu());
            t.setStavkeTermina(tm.getLista());

            KlijentKontroler.getInstance().updateTermin(t);
            FormaPretragaTermina fp = (FormaPretragaTermina) getParent();
            fp.refreshTable();
