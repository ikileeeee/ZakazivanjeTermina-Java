 ...
 * @author ivani
 */
public abstract class AbstraktanObjekat implements Serializable {

    public abstract String nazivTabele();
    public abstract String alijas();
    public abstract String join();
    public abstract ArrayList<AbstraktanObjekat> vratiListu(ResultSet rs) throws SQLException;
