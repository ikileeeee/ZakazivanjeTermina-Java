...
public class FormaPretragaKlijenta extends javax.swing.JDialog {
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((ModelTabeleKlijenti) tblKlijenti.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            ...
            Klijent k = ((ModelTabeleKlijenti) tblKlijenti.getModel()).getSelectedKlijent(row);
            new FormaDetaljiKlijenta(this, rootPaneCheckingEnabled, k).setVisible(true);
        }
    ...
    void refreshTable() {
        ModelTabeleKlijenti tm = (ModelTabeleKlijenti) tblKlijenti.getModel();
        tm.refreshTable();
    }
